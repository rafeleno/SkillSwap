...
const TAG_CONFIG: Record<TagVariant, { text: string, colorClass: string }> = {
  ...
  team_management: { text: 'Управление командой', colorClass: styles['tag-business'] },
  marketing_and_advertising: { text: 'Маркетинг и реклама', colorClass: styles['tag-business'] },
  sales_and_negotiation: { text: 'Продажи и переговоры', colorClass: styles['tag-business'] },
  personal_brand: { text: 'Личный бренд', colorClass: styles['tag-business'] },
  resume_and_interview: { text: 'Резюме и собеседование', colorClass: styles['tag-business'] },
  ...
  exam_preparation: { text: 'Подготовка к экзаменам (IELTS, TOEFL)', colorClass: styles['tag-languages'] },

  // home_and_comfort - коричневый
  cleaning_and_organization: { text: 'Уборка и организация', colorClass: styles['tag-home'] },
  ...
  drawing_and_illustration: { text: 'Рисование и иллюстрация', colorClass: styles['tag-arts'] },
  ...
  teaching_skills: { text: 'Навыки преподавания', colorClass: styles['tag-education'] },
